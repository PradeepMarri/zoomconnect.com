...
func Post_api_rest_v1_account_user_useridHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_api_rest_v1_account_user_useridTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_rest_v1_account_user_userId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_api_rest_v1_account_user_useridHandler(cfg),
	}
}
