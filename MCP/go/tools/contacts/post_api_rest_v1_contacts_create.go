...
func Post_api_rest_v1_contacts_createHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/rest/v1/contacts/create", cfg.BaseURL)
...
func CreatePost_api_rest_v1_contacts_createTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_rest_v1_contacts_create",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_api_rest_v1_contacts_createHandler(cfg),
	}
}
