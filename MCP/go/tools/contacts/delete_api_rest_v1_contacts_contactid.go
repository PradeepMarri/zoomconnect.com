...
func Delete_api_rest_v1_contacts_contactidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_api_rest_v1_contacts_contactidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_rest_v1_contacts_contactId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_api_rest_v1_contacts_contactidHandler(cfg),
	}
}
