...
func Post_api_rest_v1_contacts_contactid_addfromgroup_groupidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_api_rest_v1_contacts_contactid_addfromgroup_groupidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_rest_v1_contacts_contactId_addFromGroup_groupId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_api_rest_v1_contacts_contactid_addfromgroup_groupidHandler(cfg),
	}
}
