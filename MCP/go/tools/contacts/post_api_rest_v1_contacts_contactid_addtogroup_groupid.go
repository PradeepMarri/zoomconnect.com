...
func Post_api_rest_v1_contacts_contactid_addtogroup_groupidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/rest/v1/contacts/%s/addToGroup/%s", cfg.BaseURL, contactId, groupId)
...
func CreatePost_api_rest_v1_contacts_contactid_addtogroup_groupidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_rest_v1_contacts_contactId_addToGroup_groupId",
		mcp.WithDescription("addToGroup"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_api_rest_v1_contacts_contactid_addtogroup_groupidHandler(cfg),
	}
}
