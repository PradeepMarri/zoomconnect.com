...
func Get_api_rest_v1_contacts_contactidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_api_rest_v1_contacts_contactidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_rest_v1_contacts_contactId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_api_rest_v1_contacts_contactidHandler(cfg),
	}
}
