...
func Delete_api_rest_v1_voice_messageidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_api_rest_v1_voice_messageidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_rest_v1_voice_messageId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_api_rest_v1_voice_messageidHandler(cfg),
	}
}
