...
func Delete_api_rest_v1_groups_groupidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_api_rest_v1_groups_groupidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_rest_v1_groups_groupId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_api_rest_v1_groups_groupidHandler(cfg),
	}
}
