...
func Post_api_rest_v1_groups_groupid_removecontact_contactidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/rest/v1/groups/%s/removeContact/%s", cfg.BaseURL, groupId, contactId)
...
func CreatePost_api_rest_v1_groups_groupid_removecontact_contactidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_rest_v1_groups_groupId_removeContact_contactId",
		mcp.WithDescription("removeContact"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_api_rest_v1_groups_groupid_removecontact_contactidHandler(cfg),
	}
}
