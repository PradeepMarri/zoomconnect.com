...
func Post_api_rest_v1_groups_groupid_addcontact_contactidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_api_rest_v1_groups_groupid_addcontact_contactidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_rest_v1_groups_groupId_addContact_contactId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_api_rest_v1_groups_groupid_addcontact_contactidHandler(cfg),
	}
}
