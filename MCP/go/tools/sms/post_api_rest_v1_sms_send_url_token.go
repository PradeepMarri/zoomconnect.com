...
func Post_api_rest_v1_sms_send_url_tokenHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_api_rest_v1_sms_send_url_tokenTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_rest_v1_sms_send-url_token",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_api_rest_v1_sms_send_url_tokenHandler(cfg),
	}
}
