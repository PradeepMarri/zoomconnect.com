...
func Get_api_rest_v1_sms_send_url_parametersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_api_rest_v1_sms_send_url_parametersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_rest_v1_sms_send-url-parameters",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_api_rest_v1_sms_send_url_parametersHandler(cfg),
	}
}
