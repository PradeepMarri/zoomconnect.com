...
func Post_api_rest_v1_sms_send_url_parametersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/rest/v1/sms/send-url-parameters%s", cfg.BaseURL, queryString)
...
func CreatePost_api_rest_v1_sms_send_url_parametersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_rest_v1_sms_send-url-parameters",
		mcp.WithDescription("send-url-parameters"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_api_rest_v1_sms_send_url_parametersHandler(cfg),
	}
}
