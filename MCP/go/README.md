# www.zoomconnect.com MCP Server

This MCP (Model Content Protocol) server provides access to www.zoomconnect.com API functionality through HTTP, HTTPS, and STDIO transport modes.
